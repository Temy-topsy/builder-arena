        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mb-16">
          {['all', 'lead', 'organizer', 'mentor', 'judge', 'speaker'].map((cat) => (
            <button
              ...
              className={`px-4 py-2 rounded-md font-sans text-xs font-semibold capitalize tracking-wide transition-all border-2 border-black ${filter === cat
